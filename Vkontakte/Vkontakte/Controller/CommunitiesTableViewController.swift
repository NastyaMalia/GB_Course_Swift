...
class CommunitiesTableViewController: UITableViewController {
    ...
    let communities = [
        ...
        Community(name:"Ariana Grande", image: UIImage(named: "sarcasm")),
        Community(name:"Mems", image: UIImage(named: "tmblr")),
        Community(name:"F", image: UIImage(named: "sarcasm")),
        Community(name:"SpaceX", image: UIImage(named: "sarcasm")),
        Community(name:"Marvel", image: UIImage(named: "tmblr")),
        Community(name:"Hizuki", image: UIImage(named: "sarcasm")),
        Community(name:"Style", image: UIImage(named: "sarcasm")),
